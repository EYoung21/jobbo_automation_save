...
(function () {
   ...
   */
  function runStep(delayMs = 15, onDone) {
   ...
   */
  function runLoop(delayMs = 15, levelCheckIntervalMs = 500) {
    const level = getCurrentLevel();
    if (level != null && level >= 1000) {
  ...
  console.log('JOBBO automation loaded. Usage: JOBBO.runStep() or JOBBO.runLoop(). Max speed: JOBBO.runLoop(10) or JOBBO.runLoop(5).');
})();
